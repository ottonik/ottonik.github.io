<html lang="en">
  <head>
    ...
    <title>KOCHAM GITHABA</title>
  </head>
  <body>
    <h1>uwu</h1>
    <h2><input type="checkbox" class="catboy" />FEMBOY FEMBOY FEMBOY</h2>
    <a href="?ddd">sex1</a><br>
    <a href="?ddd2">sex2</a><br>
    <a href="?corn">Kukuryca</a><br><br>
    <a href="https://ottonik.github.io/">CLICK HERE BOY</a>
    <input type="number" class="loyalityId" value="985" /><br>
